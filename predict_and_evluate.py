...
def run_and_save_evaluation(pred_file, ref_file, output_file, context_len, model_name, test_data_set,
...
def pred_and_eval(inference_config_file, eval_output_file):
    ...
    linearization = generator_config['linearization']

    pred_file, ref_file, model_name = get_inference_out_path(context_len, model_path, inf_output_file)
    run_and_save_evaluation(pred_file, ref_file, eval_output_file, context_len, model_name, test_data_set, beam_size, linearization)
